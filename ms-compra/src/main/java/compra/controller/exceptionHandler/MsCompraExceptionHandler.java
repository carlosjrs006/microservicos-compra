...
import compra.service.exception.EntidadeNaoEncontradaException;
import compra.service.exception.NegocioException;
    ...
    protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
        ...
        if (body == null) {
            body = Problem.builder()
                    .timestamp(OffsetTime.from(OffsetDateTime.now()))
